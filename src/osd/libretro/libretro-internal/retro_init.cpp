...
float vector_scale= 1.0;
float vector_scale_x = 1.0;
float vector_scale_y = 1.0;
float vector_offset_x = 1.0;
float vector_offset_y = 1.0;
int vector_rotate = 0;
int vector_bright = 255;
bool res_43 = false;
