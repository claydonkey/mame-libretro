...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_VECTOR_DRIVER,                              "screen",    core_options::option_type::STRING,     "set vector driver (screen, usb_dvg, v_st , vectrx2020)" },
	{ OPTION_VECTOR_HOST,                            "vectrx2020_Device",    core_options::option_type::STRING,     "set vector tcp host (vectrx2020_H7B3I)" },
	{ OPTION_VECTOR_IP_PORT,                            "2390",    core_options::option_type::INTEGER,     "set vector ip port"},
	{ OPTION_VECTOR_PROTOCOL,                            "udp",    core_options::option_type::STRING,     "set vector ip protocol (tcp, udp)"} ,
	{ OPTION_VECTOR_COMPRESSION "(0-17)",              "0",    core_options::option_type::INTEGER,     "set vector compression level (0-17 1==SAFE) " },
	...
	{ OPTION_VECTOR_RGB,                       "0",        core_options::option_type::BOOLEAN,    "enable rgb" },
	{ OPTION_VECTOR_DWELL,                       "0",        core_options::option_type::INTEGER,    "dwell steps" },
	{ OPTION_VECTOR_DRAW_STEPS,                       "6",        core_options::option_type::INTEGER,    "draw steps" },
	{ OPTION_VECTOR_MOVE_STEPS,                       "30",        core_options::option_type::INTEGER,    "move steps" },
	{ OPTION_VECTOR_DAC_PERIOD,                       "300",        core_options::option_type::INTEGER,    "dac period" },
	...
	{ OPTION_VECTOR_OFFSET_X     ,          "0",      core_options::option_type::INTEGER,     "set vector x axis offset (-4096 to 4096)" },
	{ OPTION_VECTOR_OFFSET_Y ,              "0",      core_options::option_type::INTEGER,     "set vector y axis offset (-4096 to 4096)" },
	{ OPTION_VECTOR_BUFFER_MODE ,              "0",      core_options::option_type::INTEGER,     "set vector buffer mode" },
	{ OPTION_VECTOR_BUFFER_TYPE ,              "0",      core_options::option_type::INTEGER,     "set vector buffer type" },
