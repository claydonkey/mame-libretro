...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_VECTOR_DRIVER,                              "screen",    core_options::option_type::STRING,     "set vector driver (screen, usb_dvg, v_st , udp_dvg)" },
	{ OPTION_VECTOR_UDP_HOST,                            "vectrx2020_H7B3I",    core_options::option_type::STRING,     "set vector udp host (vectrx2020_H7B3I)" },
	{ OPTION_VECTOR_UDP_PORT,                            "2390",    core_options::option_type::STRING,     "set vector udp host on port" },
	{ OPTION_VECTOR_TCP_HOST,                            "vectrx2020_H7B3I",    core_options::option_type::STRING,     "set vector tcp host (vectrx2020_H7B3I)" },
	{ OPTION_VECTOR_TCP_PORT,                            "2390",    core_options::option_type::STRING,     "set vector tcp host on port" },
