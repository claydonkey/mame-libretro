...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_PLUGINDATAPATH,                             "system/mame",           OPTION_STRING,     "path to home directory (read/write) location" },
	...
	{ OPTION_VECTOR_DRIVER,                              "screen",    OPTION_STRING,     "set vector driver (screen, usb_dvg, v_st)" },
	...
	{ OPTION_VECTOR_SCALE "(0.1-2.0)",                   "1.0",       OPTION_FLOAT,      "set vector serial output scale" },
	{ OPTION_VECTOR_SCALE_X "(0.1-2.0)",                 "1.0",       OPTION_FLOAT,      "set vector x axis serial output scale" },
	{ OPTION_VECTOR_SCALE_Y "(0.1-2.0)",                 "1.0",       OPTION_FLOAT,      "set vector y axis serial output scale" },
	{ OPTION_VECTOR_OFFSET_X "(0.00-2048)",              "2048",      OPTION_FLOAT,     "set vector x axis serial offset (1024)" },
	{ OPTION_VECTOR_OFFSET_Y "(0.00-2048)",              "2048",      OPTION_FLOAT,     "set vector y axis serial offset (1024)" },
	{ OPTION_VECTOR_ROTATE,                              "0",         OPTION_INTEGER,    "set vector serial rotation (0,1,2,3)" },
	{ OPTION_VECTOR_BRIGHT "(0-255)",                    "255",       OPTION_INTEGER,    "set vector threshold for bright lines (0-255)" },
