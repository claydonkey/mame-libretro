...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_VECTOR_HOST,                            "vectrx2020_H7B3I",    core_options::option_type::STRING,     "set vector tcp host (vectrx2020_H7B3I)" },
	...
	{ OPTION_VECTOR_DRAW_STEPS,                       "0",        core_options::option_type::INTEGER,    "draw steps" },
	{ OPTION_VECTOR_MOVE_STEPS,                       "0",        core_options::option_type::INTEGER,    "move steps" },
