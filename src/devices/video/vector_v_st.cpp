...
const vector_device_v_st::game_info_t vector_device_v_st::s_games[] ={
...
//
uint32_t vector_device_v_st::compute_code(int32_t x, int32_t y)
{
...
//
uint32_t vector_device_v_st::line_clip(int32_t *pX1, int32_t *pY1, int32_t *pX2, int32_t *pY2)
{
...
void vector_device_v_st::cmd_vec_postproc()
{
    int32_t  last_x = 0;
    int32_t  last_y = 0;
    int32_t  x0, y0, x1, y1;
...
//
void vector_device_v_st::cmd_reset(uint32_t initial)
{
    m_in_vec_last_x  = 0;
    m_in_vec_last_y  = 0;
    m_in_vec_cnt     = 0;
...
//
void vector_device_v_st::cmd_add_vec(int x, int y, rgb_t color, bool screen_coords)
{
    uint32_t   blank, add;
    int32_t    x0, y0, x1, y1;
...
//
void vector_device_v_st::cmd_add_point(int x, int y, rgb_t color)
{
    uint32_t   cmd;
...
// 
void  vector_device_v_st::transform_and_scale_coords(int *px, int *py)
{
    float x, y;
...
//
int vector_device_v_st::determine_game_settings()
{
    uint32_t i;
    Document d;
...
//
void vector_device_v_st::transform_final(int *px, int *py)
{
    int x, y, tmp;
    x = *px;
    y = *py;
...
void vector_device_v_st::get_dvg_info()
{
    uint32_t cmd;
    uint8_t  cmd_buf[4];
    int      result;
