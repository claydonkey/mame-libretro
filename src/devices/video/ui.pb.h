...
class Settings final :
 ...
 public:
  ...
  private:
  uint32_t _internal_compressionlevel() const;
  void _internal_set_compressionlevel(uint32_t value);
  public:
...
inline void Settings::clear_compressionlevel() {
  _impl_.compressionlevel_ = 0u;
}
inline uint32_t Settings::_internal_compressionlevel() const {
  return _impl_.compressionlevel_;
}
inline uint32_t Settings::compressionlevel() const {
  // @@protoc_insertion_point(field_get:m_st.Settings.compressionLevel)
  return _internal_compressionlevel();
}
inline void Settings::_internal_set_compressionlevel(uint32_t value) {
  
  _impl_.compressionlevel_ = value;
}
inline void Settings::set_compressionlevel(uint32_t value) {
...
inline uint32_t Settings::_internal_x_offset() const {
  return _impl_.x_offset_;
}
inline uint32_t Settings::x_offset() const {
  // @@protoc_insertion_point(field_get:m_st.Settings.x_offset)
  return _internal_x_offset();
}
inline void Settings::_internal_set_x_offset(uint32_t value) {
  
  _impl_.x_offset_ = value;
}
inline void Settings::set_x_offset(uint32_t value) {
...
inline uint32_t Settings::_internal_y_offset() const {
  return _impl_.y_offset_;
}
inline uint32_t Settings::y_offset() const {
  // @@protoc_insertion_point(field_get:m_st.Settings.y_offset)
  return _internal_y_offset();
}
inline void Settings::_internal_set_y_offset(uint32_t value) {
  
  _impl_.y_offset_ = value;
}
inline void Settings::set_y_offset(uint32_t value) {
